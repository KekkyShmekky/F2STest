...
SWEP.JamChance			= 480
SWEP.Price				= 2500
SWEP.Gaben				= 'The M16A3 is a lightweight, air-cooled, gas-operated rifle with a rotating bolt, actuated\nby direct impingement gas operation.'
SWEP.L4D				= true
...
AddSound( 'Weapon_M16.Single', 'weapons/m16_shot.wav' )
AddSound( 'Weapon_M16.Silent', 'weapons/smg_silent.wav' )
